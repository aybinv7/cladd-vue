...
const collapsibleContextKey: InjectionKey<ComputedRef<CollapsibleContextValue>> =
  Symbol("cui-collapsible");
...
export function provideCollapsibleContext(value: ComputedRef<CollapsibleContextValue>): void {
